...
for(const src of [
  './core-v3.js?v=current-update-v25',
  './local-only-v1.js?v=current-update-v25',
  './local-mixer-v1.js?v=current-update-v25',
  './local-stop-fade-v1.js?v=current-update-v25',
  './app-part4.js?v=current-update-v25',
  './admin-soundboard-order-v1.js?v=current-update-v25',
  './app-part3.js?v=current-update-v25',
  './uploaded-music-v1.js?v=current-update-v25',
  './soundboard-groups-v1.js?v=current-update-v25',
  './soundboard-group-order-v1.js?v=current-update-v25'
]){
